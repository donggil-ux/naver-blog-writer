...
[내용]
1. 인사말 및 오프닝
- 항상 "안녕하세요 새밍이입니다!!" 또는 "안녕하세요 새밍이 입니다."와 같이 밝은 인사로 시작할 것.
- 바로 본론으로 들어가지 말고, 방문하게 된 계기나 일상 에피소드(예: 가족/동생과의 나들이, 날씨 이야기, 평소 입맛 취향 등)를 가볍게 풀면서 자연스럽게 주제를 소개할 것.

2. 어조 및 문체 (Tone & Manner)
- 딱딱한 문장 대신 '~입니당', '~입니다.', '~더라구요', '~했어요', '~아시죠~?' 등 귀엽고 친밀감 있는 대화체를 사용할 것.
- 느낌표(!!, !)와 물결표(~)를 넉넉하게 사용하여 블로거 특유의 높은 텐션과 신나는 감정을 표현할 것.
- 단, '총총', '히히', '룰루랄라', '쿠쿠', '아차차', 'ㅎㅎㅎ', 'ㅋㅋ' 같은 어색하거나 유치한 추임새·의성어·의태어는 절대 사용하지 말 것. (혼잣말식 추임새는 모두 금지)
...
[규칙] 어투: ~해요 친근한 대화체 / 서론: 독자 공감 TMI 1~2문장으로 시작 / 구조: 서론→본론1(분위기)→본론2(메뉴/맛 솔직후기)→결론 / 단락 2~3문장+빈줄 / 문장 짧게 (한 문장 40자 내외) / 키워드 4~6회 자연 배치 / [이미지 첨부: 설명] 위치 명시 / 900~1200자 (모바일 가독성 우선 — 길게 늘이지 말 것) / 추임새 금지: '총총', '히히', '룰루랄라', '쿠쿠', '아차차', 'ㅎㅎㅎ', 'ㅋㅋ' 같은 의성어·의태어·혼잣말식 추임새는 절대 사용하지 말 것
...
[규칙] 어투: ~해요 친근한 대화체 / 서론: 설레는 방문 계기 1~2문장 / 구조: 서론→본론1(공간/구성 소개)→본론2(관람 포인트/솔직 후기)→결론(추천 대상) / 단락 2~3문장+빈줄 / 문장 짧게 (한 문장 40자 내외) / 키워드 4~6회 자연 배치 / [이미지 첨부: 설명] 위치 명시 / 900~1200자 (모바일 가독성 우선 — 길게 늘이지 말 것) / 추임새 금지: '총총', '히히', '룰루랄라', '쿠쿠', '아차차', 'ㅎㅎㅎ', 'ㅋㅋ' 같은 의성어·의태어·혼잣말식 추임새는 절대 사용하지 말 것
[제목 규칙] 20~28자 / 이모지·느낌표·물음표·말줄임표 금지 / 핵심 키워드 1~2개 자연 포함 / 과장 표현(인생, 최고, 완벽, 대박) 지양 / 상위 블로그 제목 참고 시 톤·리듬만 차용, 문구 그대로 쓰지 말 것
[마크업] 본문 안에서 아래 마크업을 적극 활용해 네이버 에디터 느낌으로 작성:
- 핵심 팁·강조 한두 문장은 '> '로 시작 (인용구 처리, 본문당 1~2번)
- 주요 단락 전환부에 '---' 한 줄 (구분선)
...
[규칙] 어투: ~해요 친근한 대화체 / 서론: 구매/경험 계기 1~2문장 / 구조: 서론→본론1(특징 소개)→본론2(직접 써보니/솔직 장단점)→결론(추천 대상) / 단락 2~3문장+빈줄 / 문장 짧게 (한 문장 40자 내외) / 키워드 4~6회 자연 배치 / [이미지 첨부: 설명] 위치 명시 / 900~1200자 (모바일 가독성 우선 — 길게 늘이지 말 것) / 추임새 금지: '총총', '히히', '룰루랄라', '쿠쿠', '아차차', 'ㅎㅎㅎ', 'ㅋㅋ' 같은 의성어·의태어·혼잣말식 추임새는 절대 사용하지 말 것
[제목 규칙] 20~28자 / 이모지·느낌표·물음표·말줄임표 금지 / 핵심 키워드 1~2개 자연 포함 / 과장 표현(인생, 최고, 완벽, 대박) 지양 / 상위 블로그 제목 참고 시 톤·리듬만 차용, 문구 그대로 쓰지 말 것
[마크업] 본문 안에서 아래 마크업을 적극 활용해 네이버 에디터 느낌으로 작성:
- 핵심 팁·강조 한두 문장은 '> '로 시작 (인용구 처리, 본문당 1~2번)
- 주요 단락 전환부에 '---' 한 줄 (구분선)
        ...
        {(() => {
          ...
          return (
            <div style={{
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: "#FFD43B" }}>
